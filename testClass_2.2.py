...
class Predictor:
    ...
    # 修改run()函数，传入的不是img文件可以直接跳过img转numpy.ndarray
...
# yaml_to_dict  dict_to_NSpace  将yaml文件转化为Namespace
def Yaml_to_NameSpace(cfg_path='deploy.yaml'):
